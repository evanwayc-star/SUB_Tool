...
const CSP = [
  ...
  "connect-src 'self' blob: data: subtool-local: https://cdn.jsdelivr.net https://*.jsdelivr.net https://unpkg.com https://esm.sh https://huggingface.co https://*.huggingface.co https://*.hf.co https://cdn-lfs.huggingface.co https://cdn-lfs.hf.co https://api.groq.com https://api.openai.com https://generativelanguage.googleapis.com https://dashscope.aliyuncs.com http://127.0.0.1:* http://localhost:*",
