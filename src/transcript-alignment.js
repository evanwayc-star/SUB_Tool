 ...
 */
export function resolveRecognitionAlignment({ taskMode, transcript, evidenceSegments, alignTranscriptToEvidence: alignFn = alignTranscriptToEvidence }) {
  if (taskMode !== 'align') return { segments: evidenceSegments, alignment: null };
  const alignment = alignFn({ transcript, evidenceSegments });
